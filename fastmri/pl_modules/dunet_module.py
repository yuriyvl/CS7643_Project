...
import torch
from fastmri.models import DenseUNet
...
class DenseUnetModule(MriModule):
    """
    DenseUNet training module.
    ...
    def forward(self, image):
        return self.dunet(image.unsqueeze(1)).squeeze(1)
