...
from fastmri.pl_modules import FastMriDataModule, DenseUnetModule
...
def build_args():
    ...
    default_root_dir = fetch_dir("log_path", path_config) / "dunet" / "dunet_demo"
    ...
    # module config
    parser = DenseUnetModule.add_model_specific_args(parser)
    parser.set_defaults(
    ...
    if args.recon == True:
        checkpoint_dir = pathlib.Path("../../results/denseunet")
    else:
